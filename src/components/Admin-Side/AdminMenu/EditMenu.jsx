            ...
            >
              ...
              <div className="float-left align-baseline text-left inline-block h-4 w-full">
                <div className=" inline-block w-full align-bottom">
                  <p className="inline-block ml-2 text-black text-truncate text-sm font-bold">
                    {product.name}
                  </p>
                  <button
                    onClick={() =>
                      handleDeleteProduct(idResto, product.id, tokenAdmin)
                    }
                    className=" align-bottom inline-block  font-semibold float-right mr-2 mb-1 text-sm bg-pink-500 w-12 rounded-xl"
                  >
                    Delete
                  </button>
