...
export default function Tables() {
  ...
  return  <div className=" h-full w-full  flex flex-col  overflow-auto">
                ...
                { detailTable === Number(el.tableId) &&
                  <div className={detailTable === el.tableId 
                    ...
                    {el.ordered.length > 0 && el.currentOrder.products.length > 0 &&
                      ...
                      {el.ordered.map(el => (
                        <div key={el.productId} className="h-6 mx-2 bg-gray-100 rounded-md border-b-2 border-gray-300 mt-1  ">    
